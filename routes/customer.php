...
Route::group([
    ...
    Route::group(['middleware' => 'auth:customer'], function () {
        Route::get('/change-temporary-password', \App\Http\Livewire\Customer\Auth\TemporaryPasswordChange::class)->name('password.temporary');
    });

    Route::group(['middleware' => ['auth:customer', 'password.rotate']], function () {
