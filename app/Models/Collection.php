...
class Collection extends Model implements HasMedia
{
    ...
    public function categoriesPublished(): \Illuminate\Database\Eloquent\Relations\BelongsToMany
    {
        return $this->belongsToMany(Category::class)->orderBy('title', 'asc')->published();
    }
