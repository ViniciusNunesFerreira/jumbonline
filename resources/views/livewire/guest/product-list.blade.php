    ...
    <div class="bg-white">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            ...
            <div class="max-w-7xl">
                ...
                <ul class="mt-4 py-4 text-base text-slate-500 leading-loose font-bold border-b border-indigo-500">

                    <li class=" flex items-center">
                        <x-heroicon-s-map-pin class="h-5 w-5 flex-shrink-0 text-accent" /> &nbsp;          
                        {{ $prison->logradouro }} , {{ $prison->numero }}, {{$prison->bairro}} - {{ $prison->cidade }} / {{ $prison->uf }} - CEP: {{ $prison->cep }}
                    </li>
                    <li class=" flex items-center">
                        <x-heroicon-s-phone class="h-5 w-5 flex-shrink-0 text-accent" /> &nbsp;
                        Tel:(14) 3484-1252
                    </li>
                    <li class="flex items-center">
                        <x-heroicon-s-truck class="h-5 w-5 flex-shrink-0 text-accent" /> &nbsp;
