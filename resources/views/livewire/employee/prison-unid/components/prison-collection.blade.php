<div>
    <x-card class="relative overflow-hidden">
        ...
        <x-slot:content class="-mx-4 -my-5 sm:-mx-6">
            <ul class="border border-slate-300  dark:border-slate-200/20 flex flex-wrap m-2">
                @forelse($prison->collections as $product)
                    <li class="p-4 sm:px-6 hover:bg-slate-50 dark:hover:bg-slate-800/75 border rounded-lg border-neutral-500 m-2">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">

                                <a
                                    href="{{ route('employee.collections.detail', $product) }}"
                            ...
                            <div class="pl-5 flex items-center">
                                ...
                                >
                                    <span class="sr-only">{{ __('Deletar Grupo') }}</span>
                ...
                @empty
                    <li class="py-4 text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-slate-900 dark:text-slate-200">
                            Sem Grupos de Produto
                        </h3>
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                           Não há grupos vinculados
                        </p>
                        <div class="mt-6">
                            <button
                                wire:click.prevent="browse"
