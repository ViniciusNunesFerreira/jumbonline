                ...
                >
                    <div>
                        ...
                        <x-input
                            ...
                            :placeholder="__('Digite nome do Grupo')"
                        />
                        <x-input-error for="collection.title" class="mt-2" />
                    </div>
                    ...
                    <div>
                        ...
                        <x-input-error for="collection.slug" class="mt-2" />
                    </div>
                    ...
                    <div>
                        ...
                        <x-input-error for="collection.description" class="mt-2" />
                    </div>
                </fieldset>
            </x-slot:content>
            <x-slot:footer>
