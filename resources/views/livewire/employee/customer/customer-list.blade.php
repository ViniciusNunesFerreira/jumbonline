                    ...
                    <x-slot:content>
                        <div class="max-w-lg mx-auto text-center py-6">
                            <span class="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-accent-50 dark:bg-accent-500/10">
                                <x-heroicon-o-user-group class="h-7 w-7 text-accent-500" />
                            </span>
                        ...
                        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                            ...
                            <div class="flex flex-wrap items-end gap-3">
                                <div>
                                    ...
                                    <x-select wire:model="filterPrisonUnit" class="mt-1 !h-10 rounded-xl text-sm">
                                ...
                                <div>
                                    ...
                                    <x-input
                                        ...
                                        type="number"
                                        step="0.01"
                                        class="mt-1 h-10 w-28 rounded-xl text-sm"
                                        placeholder="0,00"
                                    />
                                </div>
                                    ...
                                    >
                                        ...
                                        >
                                            <div class="m-auto flex items-center space-x-2">
                                                <p class="text-sm text-slate-500 dark:text-slate-300">{{ 'Buscando clientes...' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <tbody class="divide-y divide-slate-100 dark:divide-white/5">
                                            @forelse($customers as $customer)
                                                ...
                                                >
                                                    ...
                                                    <td class="pl-3 pr-4 py-4 text-right text-sm font-semibold text-primary whitespace-nowrap sm:pr-6 dark:text-slate-200">
                                                        <x-money :amount="$customer->ltv_total" />
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td class="px-3 py-12 text-sm text-slate-500 text-center whitespace-nowrap dark:text-slate-400" colspan="5">
