                ...
                <x-slot:content>
                    <div class="max-w-lg mx-auto text-center">
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                            {{ __('Você precisa certificar que tem produtos cadastrados. Se sim, é só adicionar seus kits!') }}
                        </p>
                            ...
                            <div class="relative overflow-hidden">
                                ...
                                >
                                    ...
                                    >
                                        <div class="m-auto flex items-center space-x-2">
                                            <p class="text-sm dark:text-slate-200">{{ 'Lendo Kits...' }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-200/10">
                                    ...
                                    @forelse($kits as $kit)
                                        ...
                                        <tr wire:loading.class.delay="opacity-50" class="relative hover:bg-slate-50 dark:hover:bg-slate-800/75">

                                                <td class="relative w-12 px-6 sm:w-16 sm:px-8">
                                                    @if(in_array($kit->id, $selected))
                                                        <div class="absolute inset-y-0 left-0 w-0.5 bg-sky-500 dark:bg-sky-400"></div>
                                                    @endif
                                                    <x-input
                                                        wire:model="selected"
                                                        wire:key="checkbox-{{ $kit->id }}"
                                                        type="checkbox"
                                                        value="{{ $kit->id }}"
                                                        class="absolute left-4 top-1/2 -mt-2 h-4 w-4 !rounded !shadow-none sm:left-6"
                                                    />
                                                    ...
                                                    <div class="flex items-center">
                                                        <div class="h-10 w-10 flex-shrink-0">
                                                            <img
                                                                ...
                                                                src="{{ $kit->getFirstMediaUrl('gallery', 'thumb') }}"
                                                                alt="{{ $kit->title }}"
                                                            >
                                                        </div>
                                                        <div class="ml-4">
                                                            <a
                                                                href="{{ route('employee.kits.detail', $kit) }}"
                                                ...
                                                <td class="relative px-3 py-4 text-sm text-slate-500 text-center whitespace-nowrap dark:text-slate-400">
                                                    <a
                                                        ...
                                                        class="inline-flex items-center truncate hover:text-sky-600 dark:hover:text-sky-400"
                                                    >
                                                        <x-heroicon-o-eye class=" h-6 w-6 mx-auto text-slate-400 dark:text-slate-500" />
                                                    </a>
                                                </td>
