            ...
            <x-slot:content>
                ...
                >
                    ...
                    <div>
                        <x-input-label
                            for="title"
                            :value="__('Titulo do Kit')"
                        />

                        <x-input
                            wire:model.lazy="kit.title"
                            type="text"
                            id="title"
                            class="mt-1 block w-full sm:text-sm"
                            :placeholder="__('Informe o nome do Kit')"
                        />
        ...
        <x-modal-dialog wire:model.defer="showImageModal">
            ...
            <x-slot:content>
                ...
                <ul class="mt-8 grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 sm:gap-x-6 md:grid-cols-4 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                    ...
                    @foreach ($this->kit->getMedia('images')->reverse() as $image)
                        <li class="relative">
                            <div
