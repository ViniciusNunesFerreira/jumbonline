<aside
    wire:ignore
    class="pb-4 flex overflow-x-auto border-b border-slate-200/70 xl:block xl:w-64 xl:flex-none xl:border-0 xl:pb-0 dark:border-white/10"
>
    <nav class="flex-none">
        <ul role="list" class="flex gap-x-1 gap-y-1 whitespace-nowrap xl:flex-col">
            <li>
                
                <a href="{{ route('employee.settings.general') }}"
                    @class(['group flex gap-x-3 rounded-xl py-2 pl-2 pr-3 text-sm font-semibold transition-colors', 'bg-accent-50 text-accent-700 dark:bg-accent-500/10 dark:text-accent-400' => request()->routeIs('employee.settings.general'), 'text-slate-600 hover:text-primary hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-white/5 dark:hover:text-white' => ! request()->routeIs('employee.settings.general')])
                >
                    <x-heroicon-o-building-storefront @class(['h-5 w-5 shrink-0', 'text-accent-600 dark:text-accent-400' => request()->routeIs('employee.settings.general'), 'text-slate-400 group-hover:text-primary dark:group-hover:text-white' => ! request()->routeIs('employee.settings.general')]) />
                    {{ __('Geral') }}
                </a>
            </li>
            ...
            <li>
                    ...
                    <a href="{{ route('employee.settings.branding') }}"
                    @class(['group flex gap-x-3 rounded-xl py-2 pl-2 pr-3 text-sm font-semibold transition-colors', 'bg-accent-50 text-accent-700 dark:bg-accent-500/10 dark:text-accent-400' => request()->routeIs('employee.settings.branding'), 'text-slate-600 hover:text-primary hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-white/5 dark:hover:text-white' => ! request()->routeIs('employee.settings.branding')])
                >
                    <x-heroicon-o-star @class(['h-5 w-5 shrink-0', 'text-accent-600 dark:text-accent-400' => request()->routeIs('employee.settings.branding'), 'text-slate-400 group-hover:text-primary dark:group-hover:text-white' => ! request()->routeIs('employee.settings.branding')]) />
                    {{ __('Marca') }}
                </a>
            </li>
            ...
            <li>
                ...
                >
                    <x-heroicon-o-user-circle @class(['h-5 w-5 shrink-0', 'text-accent-600 dark:text-accent-400' => request()->routeIs('employee.settings.user.*'), 'text-slate-400 group-hover:text-primary dark:group-hover:text-white' => ! request()->routeIs('employee.settings.user.*')]) />
                    {{ __('Usuários') }}
                </a>
            </li>
            ...
            <li>
                    ...
                    <a href="{{ route('employee.settings.navigation') }}"
                    @class(['group flex gap-x-3 rounded-xl py-2 pl-2 pr-3 text-sm font-semibold transition-colors', 'bg-accent-50 text-accent-700 dark:bg-accent-500/10 dark:text-accent-400' => request()->routeIs('employee.settings.navigation'), 'text-slate-600 hover:text-primary hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-white/5 dark:hover:text-white' => ! request()->routeIs('employee.settings.navigation')])
                >
                    <x-heroicon-o-bars-3-bottom-left @class(['h-5 w-5 shrink-0', 'text-accent-600 dark:text-accent-400' => request()->routeIs('employee.settings.navigation'), 'text-slate-400 group-hover:text-primary dark:group-hover:text-white' => ! request()->routeIs('employee.settings.navigation')]) />
                    {{ __('Navegação') }}
                </a>
            </li>
            ...
            <li>
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" @class(['h-5 w-5 shrink-0 fill-current', 'text-accent-600 dark:text-accent-400' => request()->routeIs('employee.settings.layout'), 'text-slate-400 group-hover:text-primary dark:group-hover:text-white' => ! request()->routeIs('employee.settings.layout')])>
            ...
            <li>
                    ...
                    <a href="{{ route('employee.settings.template') }}"
                    @class(['group flex gap-x-3 rounded-xl py-2 pl-2 pr-3 text-sm font-semibold transition-colors', 'bg-accent-50 text-accent-700 dark:bg-accent-500/10 dark:text-accent-400' => request()->routeIs('employee.settings.template'), 'text-slate-600 hover:text-primary hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-white/5 dark:hover:text-white' => ! request()->routeIs('employee.settings.template')])
                >
            ...
            <li>
                    ...
                    <a href="{{ route('employee.settings.payments') }}"
                    @class(['group flex gap-x-3 rounded-xl py-2 pl-2 pr-3 text-sm font-semibold transition-colors', 'bg-accent-50 text-accent-700 dark:bg-accent-500/10 dark:text-accent-400' => request()->routeIs('employee.settings.payments'), 'text-slate-600 hover:text-primary hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-white/5 dark:hover:text-white' => ! request()->routeIs('employee.settings.payments')])
                >
                    <x-heroicon-o-credit-card @class(['h-5 w-5 shrink-0', 'text-accent-600 dark:text-accent-400' => request()->routeIs('employee.settings.payments'), 'text-slate-400 group-hover:text-primary dark:group-hover:text-white' => ! request()->routeIs('employee.settings.payments')]) />
                    {{ __('Pagamentos') }}
                </a>
            </li>
            ...
            <li>
                    ...
                    <a href="{{ route('employee.settings.checkout') }}"
                    @class(['group flex gap-x-3 rounded-xl py-2 pl-2 pr-3 text-sm font-semibold transition-colors', 'bg-accent-50 text-accent-700 dark:bg-accent-500/10 dark:text-accent-400' => request()->routeIs('employee.settings.checkout'), 'text-slate-600 hover:text-primary hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-white/5 dark:hover:text-white' => ! request()->routeIs('employee.settings.checkout')])
                >
                    <x-heroicon-o-shopping-cart @class(['h-5 w-5 shrink-0', 'text-accent-600 dark:text-accent-400' => request()->routeIs('employee.settings.checkout'), 'text-slate-400 group-hover:text-primary dark:group-hover:text-white' => ! request()->routeIs('employee.settings.checkout')]) />
                    {{ __('Checkout') }}
                </a>
            </li>
            ...
            <li>
                    ...
                    <a href="{{ route('employee.settings.inventory') }}"
                    @class(['group flex gap-x-3 rounded-xl py-2 pl-2 pr-3 text-sm font-semibold transition-colors', 'bg-accent-50 text-accent-700 dark:bg-accent-500/10 dark:text-accent-400' => request()->routeIs('employee.settings.inventory'), 'text-slate-600 hover:text-primary hover:bg-slate-50 dark:text-slate-400 dark:hover:bg-white/5 dark:hover:text-white' => ! request()->routeIs('employee.settings.inventory')])
                >
