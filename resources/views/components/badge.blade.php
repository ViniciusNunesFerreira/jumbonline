...
@php
    $color = [
        ...
        'primary' => 'bg-accent-50 text-accent-700 ring-1 ring-inset ring-accent-600/20 dark:bg-accent-400/10 dark:text-accent-400 dark:ring-accent-400/20',
...
<span {{ $attributes->merge(['class' => 'inline-flex items-center rounded-full font-semibold ' . $color . ' ' . $size]) }}>
    {{ $slot }}
</span>